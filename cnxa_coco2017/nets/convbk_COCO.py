...
class BIGKS(nn.Module):
    def __init__(self, channel, ratio=4, kernel_size=[21, 19], stride=1, I=0, N=0, use_gpu=True, pad=''):
...
def convbk_base(num_classes: int, pretrained=False, use_gpu=True, pad='',**kwargs):
