...
if __name__ == "__main__":
    ...
    #   获得图片路径和标签, 使用对应数据集的
    # ------------------------------------------------------#
    annotation_path = "cls_train_coco2017.txt"
    annotation_path_ = "cls_test_coco2017.txt"
    # ------------------------------------------------------#
    ...
    if backbone != "vit":
        model = get_model_from_name[backbone](num_classes=num_classes, pretrained=pretrained, aa=aa, pad=pad)
