...
class DataGenerator(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        d = list(map(int, c))
        """
        step1 = list(self.annotation_lines[index].split(';')[0])[1: len(self.annotation_lines[index].split(';')[0]) - 1]
        step2 = step1[0: len(step1): 3]

        # print(len(self.annotation_lines[index].split(';')[0]))
        # y = int(self.annotation_lines[index].split(';')[0])
        y = list(map(int, step2))
