...
class ConvNeXtAa(nn.Module):
    ...
    def __init__(self, in_chans=3, num_classes=1000,
                 ...
                 layer_scale_init_value=1e-6, head_init_scale=1., aa="ca", in_channel=768
                 ):
        super().__init__()
        if aa == "ca":
...
def convnextaa_base(num_classes: int, pretrained=True, weights='', aa="ca", in_channel=768, **kwargss):
    ...
    if pretrained:
        ...
        # weights_dict = torch.load("/data/CNXA_COCO/model_data/convnext_base_1k_224_ema.pth")["model"]
