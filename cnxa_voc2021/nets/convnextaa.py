...
def convnextaa_base(num_classes: int, pretrained=False, aa="ca", **kwargs):
    ...
    if pretrained:
        ...
        weights_dict = torch.load("/data/CNXA_VOC2021/model_data/convnext_base_1k_224_ema.pth")["model"]
        # 删除有关分类类别的权重
